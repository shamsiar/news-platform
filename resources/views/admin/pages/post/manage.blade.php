                            ...
                            <div class="table-responsive table-card">
                                <table class="table table-nowrap table-centered align-middle table-hover table-striped" id="example">
                                    ...
                                    @else
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="action-buttons">
                                                    <li>
                                                        <button type="button" class="btn btn-success btn-sm btn-icon waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#viewPost{{ $post->id }}">
                                                            <i class="ri-eye-line"></i>
                                                        </button>
                                                    </li>

                                                    <li>
                                                        <a href="{{ route('post.edit', $post->id) }}" class="btn btn-primary btn-sm waves-effect waves-light">
                                                            <i class="ri-pencil-line"></i>
                                                        </a>
                                                    </li>

                                                    <li>
                                                        <button type="button" class="btn btn-danger btn-sm btn-icon waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#deletePost{{ $post->id }}">
                                        ...
                                        <!-- View Modal -->
                                        <div id="viewPost{{ $post->id }}" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-center">
                                                        @if ( !empty( $post->icon ) )
                                                            <img src="{{ asset('uploads/icon/' . $post->icon ) }}" class="rounded-circle me-1 mb-10" alt="">
                                                        @endif
                                        ...
                                        <div id="deletePost{{ $post->id }}" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"> </button>
                                                    ...
                                                    <div class="modal-body text-center p-5">
                                                            ...
                                                            <div class="mt-4">
                                                                ...
                                                                <p class="text-muted mb-4"> If Yes, The decision can't be change and the News will be removed permanently.</p>
